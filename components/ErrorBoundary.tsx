      ...
      return (
        <div className="flex flex-col items-center justify-center h-screen bg-gray-900 text-white p-6">
          <div className="bg-gray-800 rounded-lg shadow-xl border border-gray-700 w-full max-w-md p-8 text-center space-y-6">
            ...
            <p className="text-gray-300 text-lg">Sorry, the application encountered an unexpected problem.</p>
            ...
            <p className="text-gray-500 text-xs">Please try reloading the page. If the problem persists, please contact support.</p>
            <button
